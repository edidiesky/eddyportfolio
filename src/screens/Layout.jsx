        ...
        <div className="w-100 flex item-center footer_right justify-end">
          <div className="flex column fs-14 gap-2 text-extra-bold">
            ...
            <div className="w-100 flex gap-3 item-center">
              <Link to={'/'} className="block span_highlight text-white">Github</Link>
              <Link to={'/'} className="block span_highlight text-white">Facebook</Link>
              <Link to={'/'} className="block span_highlight text-white">Twitter</Link>
              <Link to={'/'} className="block span_highlight text-white">Linkedln</Link>
            </div>
          </div>
        </div>
      </div>
