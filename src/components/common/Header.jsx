    ...
    <div className="w-full">
      <div className="w-100 w-full px-8 m-auto max-w-custom py-8">
        <div className="w-90 auto hero_top_wrapper flex item-center justify-space gap-4">
          <Link to={"/"} className="text-lg md:text-2xl font-portfolio_bold font-normal">
            VICTOR ESSIEN
          </Link>
            ...
            <div className="w-full flex item-center justify-end gap-4">
              <div className="flex items-center gap-3 md:gap-8">
                <Link
                  ...
                  target="_blank"
                  className="text-text_dark_1 font-portfolio_bold font-normal text-[13px] md:text-sm flex item-center justify-center text-bold"
                >
                 Twitter
                </Link>
                <Link
